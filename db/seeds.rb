...
appointment_1 = Appointment.create(time: DateTime.new(2023, 1, 1, 9, 0), start_time: DateTime.new(2023, 1, 1, 9, 0), end_time: DateTime.new(2023, 1, 1, 10, 0), specialty: "medicina general", pet: lupe, vet: vet_1 )
